...
exports.long = async () => {
    ...
    // console.log(await _this.usdcToBtc('0x7e2411'))
    // console.log(await _this.btcToUsdc('0x9efe'));
    // return true;
    ...
    // Take note of any existing WBTC
    const wbtcBalance = dhedge.getBalance(poolInfo, dhedge.tokens.WBTC);

    // Do we have any USDC?
    const usdcBalance = dhedge.getBalance(poolInfo, dhedge.tokens.USDC);
    if (usdcBalance.gt(0)) {
